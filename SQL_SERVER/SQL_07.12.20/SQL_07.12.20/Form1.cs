...
namespace SQL_07._12._20
{
    ...
    {
        public static string connect_str = "Data Source=DESKTOP-3DIOHQI\\SQLSDEVELOPER;Initial Catalog=People;Integrated Security=True";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (rez == DialogResult.OK)
            {
                ...
                if (dataGridView1[0, k].Value != null)
                {
                    ...
                    string str_del = "delete from [dbo].[People] where [id]=" + dataGridView1[0, k].Value.ToString();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (f.ShowDialog() == DialogResult.OK)
            {
                ...
                string s = "insert into [dbo].[People]([Last_name],[First_name], " +
                    ...
                    "[Nosology],[Adress]) " +
                    "values('"+f.textBox1.Text+"','"+f.textBox2.Text+ "','" + f.textBox3.Text 
                    +"','"+f.maskedTextBox1.Text+"','"+f.textBox4.Text+"', "+
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (f.ShowDialog() == DialogResult.OK)
            {
                string s = "update [People] set [Last_name]='" + f.textBox1.Text + "'," +
                    "[First_name]='" + f.textBox2.Text + "',[First_name2]='" + f.textBox3.Text + "'," +
                    "[Phone]='" + f.maskedTextBox1.Text + "',[Email]='" + f.textBox4.Text + "'," +
                    "[Pol]='" + f.comboBox1.SelectedValue + "',[Data]='" + f.dateTimePicker1.Value + "'," +
                    "[Kategory]='" + f.comboBox2.SelectedValue + "',[Nosology]='" + f.comboBox3.SelectedValue + "'," +
                    "[Adress]='" + f.textBox5.Text + "' where[id] = " + dataGridView1[0, k].Value.ToString();
        ...
        {
            string s = " select t1.id,t1.Last_name,t1.First_name,t1.First_name2,t1.Data, " +
                " t1.Email,t1.Phone, t1.Adress, t2.Naimenovanie as Pol, t3.Naimenovanie as [Nosology], " +
                " t4.Naimenovanie as Kategory from[dbo].[People] t1 " +
                " inner join[dbo].[Pol] t2 on t1.Pol = t2.id " +
                " inner join[dbo].[Nosology] t3 on t1.Nosology=t3.id " +
                " inner join[dbo].[Kategory] t4 on t1.Kategory=t4.id " +
                " where t1.Last_name like '%"+textBox1.Text+"%'";
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "peopleDataSet3.Pol". При необходимости она может быть перемещена или удалена.
            this.polTableAdapter1.Fill(this.peopleDataSet3.Pol);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "peopleDataSet.Pol". При необходимости она может быть перемещена или удалена.
            this.polTableAdapter.Fill(this.peopleDataSet.Pol);
            load();
        }
    ...
    " inner join[dbo].[Nosology] t3 on t1.Nosology=t3.id " +
    " inner join[dbo].[Kategory] t4 on t1.Kategory=t4.id " +
    " where t1.Pol="+ comboBox1.SelectedValue;
